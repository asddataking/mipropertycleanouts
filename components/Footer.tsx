    ...
    <footer className="bg-green text-cream">
      <Container className="grid gap-10 py-16 md:grid-cols-2 lg:grid-cols-12">
        ...
        <div className="lg:col-span-2">
          <h2 className="text-sm font-bold tracking-[0.12em] uppercase">Quick Links</h2>
        ...
        <div className="lg:col-span-2">
          <h2 className="text-sm font-bold tracking-[0.12em] uppercase">Contact Us</h2>
      ...
      <div className="border-t border-cream/10">
        <Container className="flex flex-col gap-2 py-5 text-xs text-cream/55 sm:flex-row sm:items-center sm:justify-between">
          <p>
